...
def create_grid_with_titles(images, class_names, samples_per_class, guidance_scale, image_size):
    """Create a grid with class titles for 10-class setup"""
    num_classes = len(class_names)
    
    # Create figure with proper spacing for titles (10x4 for 10 classes)
...
def generate_samples(model, path, device, config, experiment_name, num_classes=10, samples_per_class=4):
    """Generate samples with different guidance scales for 10-class setup"""
    ...
    for guidance_scale in guidance_scales:
        ...
        # Sample from all classes (10 classes for 10-class setup)
