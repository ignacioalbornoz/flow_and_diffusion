...
class SketchSampler(nn.Module, util.Sampleable):
    ...
    """
    def __init__(self, data_dir: str = "/home/shared_data/Datasets/sketchy/train/sketch", max_classes: int = 50):
        super().__init__()
        ...
        self.transform = transforms.Compose([
            transforms.Resize((32, 32)),  # Resize to 32x32 like MNIST
            transforms.ToTensor(),
    ...
    def sample(self, num_samples: int) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
        ...
        Returns:
            - samples: (num_samples, 1, 32, 32) tensor of sketches
        ...
        samples = torch.cat(samples, dim=0)  # (num_samples, 1, 32, 32)
    ...
    def get_image_size(self):
        ...
        return 32  # Full resolution for research
