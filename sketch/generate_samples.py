...
def create_grid_with_titles(images, class_names, samples_per_class, guidance_scale, image_size):
    """Create a grid with class titles"""
...
def generate_samples(model, path, device, config, experiment_name, num_classes=16, samples_per_class=4):
...
def main():
    ...
    if len(sys.argv) != 2:
        ...
        print("Example: python generate_samples.py sketch_32x32_research")
        sys.exit(1)
    ...
    try:
        ...
        print(f"Run: ./start_experiment.sh {experiment_name}")
